    ...
    <div id="app">
        ...
        >
            <GmapMarker
                ...
                :title="m.userName"
            >
                <GmapInfoWindow>{{ m.userName }}</GmapInfoWindow>
            </GmapMarker>
        </GmapMap>
        <div class="notification">
            <p>{{ channel_id }} Online Users: {{ markers.length }}</p>
            <ul>
...
var ably = new Ably.Realtime({
    key: process.env.VUE_APP_ABLY_API_KEY,
...
export default {
    ...
    async created() {
        ...
        var channel = ably.channels.get(this.channel_id);
        channel.attach(err => {
            if (err) {
